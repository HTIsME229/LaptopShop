    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
                ...
                <head>
                    <meta charset="utf-8">
                    <title>Laptop Shop-${dataProduct.name}</title>
                    ...
                    <div class="container-fluid py-5 mt-5">
                        <div class="container py-5">
                            <div class="row g-4 mb-5">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-lg-6">
                                            <div class="border rounded">
                                                <a href="#">
                                                    <img src="/images/product/${dataProduct.image}"
                                        ...
                                        <div class="col-lg-6">
                                            <h4 class="fw-bold mb-3">${dataProduct.name}</h4>
                                            <p class="mb-3">Factory:${dataProduct.factory}</p>
                                            ...
                                            <p class="mb-4">${dataProduct.shortDesc}</p>
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="">
                                                                <p class="mb-2" style="font-size: 14px;">
                                                                    ...
                                                                    <fmt:formatDate value="${review.timestamp}"
                                ...
                                <form action="/post-review/${dataProduct.id} " method="post">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="border-bottom rounded my-4">
                                                <textarea class="form-control border-0" cols="30" rows="8" name="review"
