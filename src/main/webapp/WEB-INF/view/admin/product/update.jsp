                                        ...
                                        <div class="col-md-6  mx-auto">
                                            ...
                                            <form:form action="/admin/product/update/${newProduct.id}" method="post"
                                                ...
                                                <div class="row  ">
                                                    ...
                                                    <image src="/images/product/${newProduct.image}" id="avatarPreview"
                                                        class="mb-2" />

                                                </div>
                                                <form:input style="display: none;" type="text" path="image" name=""
                                                    id="" />



                                                <button type="submit" class="btn btn-primary">Submit</button>
                                                <a href="/admin/product" class="btn btn-danger">Close</a>
                                            </form:form>
